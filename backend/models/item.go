...
type Attributes struct {
	...
	ItemCategory     string `json:"itemCategory" form:"itemCategory" validate:"omitempty,oneof=electronics homeGarden fashion beauty health sports outdoors automotive books music games toys collectibles art crafts"`
